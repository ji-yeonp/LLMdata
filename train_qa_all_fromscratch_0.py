...
pretrained = None # os.path.join(PRETRAIN_FOLDER, time_stamp, exp_epoch)
...
def train_model(exp_name, repNo):
    ...
    optimizer = optim.AdamW(model.parameters(), lr=initial_lr, betas=(0.9, 0.95), weight_decay=w_decay)
